...
class GettingReadyForBirth extends StatelessWidget {
  const GettingReadyForBirth({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'assets/images/getting_ready_for_birth/grb.jpg',
              height: 250,
            ...
            Expanded(
              child: FutureBuilder<List<PregnancyCareModel>>(
                  future:
                      PregnancyCareHandler.getAllGettingReadyForBirth(context),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Image(
                                          image: AssetImage(
                                              'assets/images/getting_ready_for_birth/${pregnancyCare.image}'),
                                          height: 130,
                                          //width: 150,
                                        ),
                                      ),
